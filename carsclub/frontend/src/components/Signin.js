                ...
                <div className="firstcontainer">
                    ...
                    <div id="usersignin" style={{ display: 'block' }} className="content">
                        ...
                        <h3>
                            ...
                            <NavLink style={{ color: '#52f8ab' }} to="/signup">
                                create one
                            </NavLink>
                        </h3>
                        <button className="btn">
                            <NavLink to="/adminsignin">Signin As Admin</NavLink>
                        </button>
                        <button className="btn" onClick={()=>{
                            window.open("http://localhost:4001/distributersignin")
                        }} style={{
                            color: "purple"
                        }}>
                            {/* <NavLink to="/distributersignin">Signin As Distributor</NavLink> */}
                            <span>SIgn in As Distributor</span>
                        </button>
                    </div>
                </div>
            </div>
