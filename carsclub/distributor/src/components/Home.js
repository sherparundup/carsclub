...
<div className="box-container">
    ...
    <div className="box">
        ...
        <p>Buy your dream car at a click of a button.</p>
    ...
    <div className="box">
        <i className="fas fa-car"></i>
        <h3>Rent A Car</h3>
        <p>Rent any Car you want with affordable price at a click of a button </p>
    ...
    <i className="fas fa-car"></i>
        ...
        <p>sale your old car with people who are intrested to buy</p>
...
<div className="box-container">
    ...
    <div className="box">
        ...
        <a href="#"> <i className="fas fa-map-marker-alt"></i> jhapa </a>
        <a href="#"> <i className="fas fa-map-marker-alt"></i> lalitpur </a>
        <a href="#"> <i className="fas fa-map-marker-alt"></i> chitwan </a>
    </div>
    ...
    <div className="box">
        ...
        <a href="#"> <i className="fas fa-envelope"></i> sherparundup@gmail.com</a>
        <a href="#"> <i className="fas fa-map-marker-alt"></i> kathmandu, Nepal </a>
    </div>
...
<div className="credit"> created by Team5 | all rights reserved </div>
